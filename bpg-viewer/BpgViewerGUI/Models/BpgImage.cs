...
{
    /// <summary>
    /// Represents a decoded BPG image with managed resources
    /// </summary>
    public class BpgImage : IDisposable
    {
        ...
        private BpgImage(IntPtr handle, uint width, uint height, long fileSizeBytes)
        {
            _handle = handle;
            Width = width;
            Height = height;
        ...
        /// </summary>
        public static BpgImage? Load(string filePath)
        {
            ...
            var image = new BpgImage(handle, width, height, fileSizeBytes);
