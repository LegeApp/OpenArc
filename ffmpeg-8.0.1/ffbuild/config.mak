...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/d/misc/arc/openarc/ffmpeg-build --enable-static --disable-shared --disable-programs --disable-doc --disable-debug --enable-gpl --enable-version3 --disable-all --enable-avcodec --enable-avformat --enable-avutil --enable-swscale --enable-swresample --enable-libx264 --enable-libx265 --enable-encoder='libx264,libx265,aac,flac' --enable-decoder='h264,hevc,aac,flac' --enable-parser='h264,hevc,aac,flac' --enable-muxer='mp4,matroska,flac' --enable-demuxer='h264,hevc,mov,matroska,flac' --enable-protocol=file --enable-bsf='h264_mp4toannexb,hevc_mp4toannexb' --enable-filter='scale,format,null' --arch=x86_64 --target-os=mingw32
...
CC_IDENT=gcc 15.2.0 (Rev8, Built by MSYS2 project)
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=
CC=gcc
...
CFLAGS-ffplay=-IC:/msys64/mingw64/include/SDL2 -Dmain=SDL_main
...
EXTRALIBS-avcodec=-liconv -lm -latomic -lx264 -lx265 -lole32 -luser32
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lva_win32 -lva -lm -luser32 -lva -lbcrypt -latomic
EXTRALIBS-ffplay=-lmingw32 -lSDL2main -lSDL2 -lshell32
