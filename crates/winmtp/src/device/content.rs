...
use windows::Win32::Devices::PortableDevices::{
    IPortableDeviceContent, IPortableDeviceKeyCollection, PortableDeviceKeyCollection,
...
impl Content {
    ...
    pub fn object_by_id(&self, object_id: U16CString) -> crate::WindowsResult<Object> {
        ...
        let basic_properties =
            self.properties(&object_id, &[WPD_OBJECT_NAME, WPD_OBJECT_CONTENT_TYPE])?;
    ...
    pub fn properties(
    ...
    ) -> crate::WindowsResult<DeviceValues> {
        ...
        unsafe { properties.GetValues(PCWSTR::from_raw(object_id.as_ptr()), &props_to_read) }
