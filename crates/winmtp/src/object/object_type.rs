...
use windows::Win32::Devices::PortableDevices::{
    WPD_CONTENT_TYPE_ALL, WPD_CONTENT_TYPE_APPOINTMENT, WPD_CONTENT_TYPE_AUDIO,
    WPD_CONTENT_TYPE_AUDIO_ALBUM, WPD_CONTENT_TYPE_CALENDAR, WPD_CONTENT_TYPE_CERTIFICATE,
    WPD_CONTENT_TYPE_CONTACT, WPD_CONTENT_TYPE_CONTACT_GROUP, WPD_CONTENT_TYPE_DOCUMENT,
    WPD_CONTENT_TYPE_EMAIL, WPD_CONTENT_TYPE_FOLDER, WPD_CONTENT_TYPE_FUNCTIONAL_OBJECT,
    WPD_CONTENT_TYPE_GENERIC_FILE, WPD_CONTENT_TYPE_GENERIC_MESSAGE, WPD_CONTENT_TYPE_IMAGE,
    WPD_CONTENT_TYPE_IMAGE_ALBUM, WPD_CONTENT_TYPE_MEDIA_CAST, WPD_CONTENT_TYPE_MEMO,
    WPD_CONTENT_TYPE_MIXED_CONTENT_ALBUM, WPD_CONTENT_TYPE_NETWORK_ASSOCIATION,
    WPD_CONTENT_TYPE_PLAYLIST, WPD_CONTENT_TYPE_PROGRAM, WPD_CONTENT_TYPE_SECTION,
    WPD_CONTENT_TYPE_TASK, WPD_CONTENT_TYPE_TELEVISION, WPD_CONTENT_TYPE_UNSPECIFIED,
    WPD_CONTENT_TYPE_VIDEO, WPD_CONTENT_TYPE_VIDEO_ALBUM, WPD_CONTENT_TYPE_WIRELESS_PROFILE,
};
