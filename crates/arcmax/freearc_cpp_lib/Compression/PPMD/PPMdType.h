...
// Include Compression.h first to get Windows types from Common.h
// This avoids conflicts between our type definitions and windows.h
#include "../Compression.h"

// Only define types if not already provided by Windows headers
#ifndef _WINDEF_
typedef int BOOL;
#define FALSE 0
#define TRUE 1
