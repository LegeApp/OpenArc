...
#ifdef _WIN32
// Avoid conflict with Windows FARPROC
typedef int (*FREEARC_FARPROC)(void);
#define FARPROC FREEARC_FARPROC
#else
...
static inline char *show3_impl(uint64 n, char *buf, const char *prepend) {
